...
# username, id, name, surname, dateOfBirth, nation, allergies, restrictions, disliked_ingredients, evolving_diet, reminder, lastInteraction, tastes):

#Utility functions
def get_user_data():
    return ud.User("Test", 0, None, None, None, None, None, None, None, None, None, None, None)

def get_valid_user_data():
    return ud.User("Test", 0, "Giacomo", "Rossi", "01/01/1990", "Italy", [], [],[], [], False, "", [])

def get_valid_user_data2():
    return ud.User("Test", 0, "Giacomo", "Rossi", "01/01/1990", "Italy", ["fish"], [],[], [], False, "", [])
